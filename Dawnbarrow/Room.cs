...
namespace Dawnbarrow
{
    internal class Room
    {
        ...
        {
            public (int x, int y) Coordinates = (3,3);
        ...
        public Room()
        {
            ...
            {   // coords, North, South, East, West (cango)
                ...
                new Roomdata(5,4, true, true, true, true),
                new Roomdata(1,3, true, true, true, false),
                new Roomdata(2,3, true, true, true, true),
                new Roomdata(3,3, true, true, false, false), //starting room :)
                new Roomdata(4,3, true, true, true, true),
                new Roomdata(5,3, true, true, true, false),
                new Roomdata(1,2, true, true, true, true),
                new Roomdata(2,2, true, true, true, false),
                new Roomdata(3,2, true, true, true, true),
                new Roomdata(4,2, true, true, true, false),
                new Roomdata(5,2, true, true, true, true),
                new Roomdata(1,1, true, true, true, false),
                new Roomdata(2,1, true, true, true, true),
                new Roomdata(3,1, true, true, true, false),
                new Roomdata(4,1, true, true, true, true),
                new Roomdata(5,1, true, true, true, false),
             };
            currRoomCoordinates = (3, 3);
        }
